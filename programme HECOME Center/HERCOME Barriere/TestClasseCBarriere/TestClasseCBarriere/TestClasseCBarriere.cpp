...
// TestClasseCBarriere.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTestClasseCBarriereApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTestClasseCBarriereApp

CTestClasseCBarriereApp::CTestClasseCBarriereApp()
{
...
// Seul et unique objet CTestClasseCBarriereApp

CTestClasseCBarriereApp theApp;


// initialisation de CTestClasseCBarriereApp

BOOL CTestClasseCBarriereApp::InitInstance()
{
