...
// TestClasseCCapteur.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTestClasseCCapteurApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTestClasseCCapteurApp

CTestClasseCCapteurApp::CTestClasseCCapteurApp()
{
...
// Seul et unique objet CTestClasseCCapteurApp

CTestClasseCCapteurApp theApp;


// initialisation de CTestClasseCCapteurApp

BOOL CTestClasseCCapteurApp::InitInstance()
{
