...
// TestClasseCOpenAlpr.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTestClasseCOpenAlprApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTestClasseCOpenAlprApp

CTestClasseCOpenAlprApp::CTestClasseCOpenAlprApp()
{
...
// Seul et unique objet CTestClasseCOpenAlprApp

CTestClasseCOpenAlprApp theApp;


// initialisation de CTestClasseCOpenAlprApp

BOOL CTestClasseCOpenAlprApp::InitInstance()
{
