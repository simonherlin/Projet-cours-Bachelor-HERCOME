================================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet HERCOME_Barriere
===============================================================================

L'Assistant Application a créé cette application HERCOME_Barriere pour vous. Cette application décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre application.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application HERCOME_Barriere.

HERCOME_Barriere.vcxproj
...
HERCOME_Barriere.vcxproj.filters
...
HERCOME_Barriere.h
    ...
    Il comprend d'autres en-têtes spécifiques au projet (notamment Resource.h) et déclare la classe d'application CHERCOME_BarriereApp.

HERCOME_Barriere.cpp
    Il s'agit du fichier source principal de l'application qui contient la classe d'application CHERCOME_BarriereApp.
...
res\HERCOME_Barriere.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application. Cette icône est incluse par le fichier de ressources principal HERCOME_Barriere.rc.

res\HERCOME_Barriere.rc2
...
HERCOME_BarriereDlg.h, HERCOME_BarriereDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CHERCOME_BarriereDlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans HERCOME_Barriere.rc, qui peut être modifié dans Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) HERCOME_Barriere.pch et un fichier de type précompilé nommé StdAfx.obj.
