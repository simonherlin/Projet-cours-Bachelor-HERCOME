...
// TestClasseBdd.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTestClasseBddApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTestClasseBddApp

CTestClasseBddApp::CTestClasseBddApp()
{
...
// Seul et unique objet CTestClasseBddApp

CTestClasseBddApp theApp;


// initialisation de CTestClasseBddApp

BOOL CTestClasseBddApp::InitInstance()
{
