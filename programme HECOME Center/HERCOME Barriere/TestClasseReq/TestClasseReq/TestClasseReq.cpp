...
// TestClasseReq.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTestClasseReqApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTestClasseReqApp

CTestClasseReqApp::CTestClasseReqApp()
{
...
// Seul et unique objet CTestClasseReqApp

CTestClasseReqApp theApp;


// initialisation de CTestClasseReqApp

BOOL CTestClasseReqApp::InitInstance()
{
