...
********************************************************************************************************/
		...
		JLabel lblTemperatureInterneDemande = new JLabel("Temp\u00E9rature interne demandé");
		...
		JLabel lblLumiere = new JLabel("Lumière");
		...
		JLabel lblLumiereAllume = new JLabel("Nombre de lumière allumée(s)");
		...
		JLabel lblStationMeteo = new JLabel("Station météo");
		...
		JLabel lblHumidite = new JLabel("humidité");
